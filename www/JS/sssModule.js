...
// TODO: Supabase Dashboard → add both site URL and capacitor://localhost to Redirect URLs
// TODO: Google Cloud Console → Android OAuth client (packageName + SHA-1)
  ...
  if (data?.url) {
    if (isNativeApp) {
      ...
      if (!Browser || typeof Browser.open !== 'function') {
        throw new Error("Browser plugin not available. Ensure you ran 'npx cap sync android' and rebuilt the app.");
      }
